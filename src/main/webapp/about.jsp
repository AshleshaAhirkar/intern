...
<body class="p-1 m-0 border-0 bd-example ">
	...
	<div class="bg-success p-2 text-dark bg-opacity-25">
		...
		<div class="container-fluid mt-2"
			style="background-color: #bdeecb; box-shadow: 0 0 25px 4px rgba(0, 0, 0, .05);">
			<h2 align="center">
				<b>ABOUT US</b>
			</h2>
			<hr>
			<div class="row">
				<div class="col-md-8">
					<p>
						IT has changed the whole scenario and has thrown open many
						opportunities all over the world. We Indians have also gained
						respect in this progressing global village of information
						Technology. In recent times, Computer Education has become a
						buzzword in every walk of life and, in the process, many computer
						institutes in have mushroomed up.<span class="text-danger">Therefore,
							it has become more imperative to choose the right institute which
							can assure your success in the chosen courses.</span>
					</p>

					<p>
						We take this opportunity to introduce us as an institute engaged
						in providing Basic as well as Advanced Software Education in South
						Nagpur. As an Institute, We have always strived to impart quality
						computer education to the students who joined the computer courses
						with us and always given emphasis on small batches to provide
						greater attention and personal intervention to ensure the students
						progress.<span class="text-danger">The methodology of our
							training and consistent guidance to students have gone a long way
							in shaping the future and daring of many students who are now
							top-notch professionals in the IT sector.</span>
					</p>

					<p>Today, we are proud of our accomplishments and achievements.
						Our institute has completed 16 years. It's a matter of pride that
						students who have enrolled for our courses in the last 16 years
						have achieved many milestones. The success of our students stands
						as a testimony to our intention, integrity, efforts, and
						efficiency. Our batches for B.E, Poly, B.sc comp. Sci., BCCA, MCA,
						MCM, M.Sc. Comp Sci. and can boast about an impressive list of
						achievers and a successful set of students.</p>

					<p>
						<span class="text-danger">Our institute has an edge over
							all the other institutes. Our map speaks and talks about us.</span>
						Students generally prefer our institute for two reasons. Firstly,
						they will get self-explanatory, tailor-made, perfect, and easy to
						comprehend notes for their university exam. This enables them to
						score high marks. Secondly, they will have access to the best
						teachers who guarantee the best practical knowledge and all
						practical concepts and fundamentals are cleared. This enables the
						students to be absolutely geared up for their corporate stint.
					</p>
				</div>

				<div class="image-container col-md-4">
					<img src="sir.jpg" alt="About us"
						class="img-fluid animate__animated animate__bounceInLeft">
				</div>
		...
		<div class="container-fluid mt-2 " id="mission"
			style="background-color: #bdeecb">
			<h1 align="center">OUR MISSIONS</h1>
			<hr>
			<p>
			<p>
				<span class="text-danger">Advance Computer Center aims at
					empowering individuals and organization in enquiring, enhancing and
					upgrading the work efficiency by enhancing the overall problem
					solving approach via use of technology and computers. It makes sure
					that the programmes undertaken are recognized globally, high on
					quality and in coherence with the demand of the changing times.</span> We
				are research based organization who believe in continuous
				development of our own self as well as those associate with us.
				Advance Computer Center has been one of the very few computers
				training institute which can proudly boast of ISO 9001:2008
				certification which is one of the parameter to gauge our quality
				consciousness. With a vision to train and mould the best IT
				professionals, Advance Computer Center has established itself as a
				leading training institute. Advance Computer Center has a strong
				focus on quality training and has pioneered a unique way to groom
				students with its Smartlab Plus training methodology. We teach a
				range of classes that start with the very basic computer user and
				extends to the very advanced technical student.
			</p>

		</div>


		<div class="container-fluid mt-2" id="goals"
			style="background-color: #bdeecb">
			<h1 align="center">OUR GOALS</h1>
			<hr>
			<!--            <p>The Mission of the <strong>Advance Infotech Pvt. Ltd.</strong> is to eradicate illiteracy from the weaker section and to provide cheap and quality education.</p> <p> It is also planned to introduce such courses which may generate self-employment.</p> <p>We will build up its wide network of education centers in all over India in coming years.</p> <p> Students who don’t know About Computer Knowledge, Our mission is to provide them a proper Training at very Affordable Fees and provide them a Job opportunity to achieve that target.</p>-->

			<ul style-type: square class="fs-4">
				<li>To Provide access to education without the limits of time,
					place and distance.</li>
				<li>To Provide career programs that meets the need of students
					and employees.</li>
				<li>To Provide opportunities for personal growth and cultural
					enrichment.</li>
				<li>To deliver support programs to help students achieve their
					goals.</li>
				<li>To lead in the creation of partnership that faster the
					economics development of the religion.</li>
				<li>To educate students with an understanding and appreciation
					of world cultures.</li>
				<li>To prepare our community to succeed in the global economy.</li>
			</ul>
