...
<html>
 ...
 <script>
        ...
        function validateForm8() {
            ...
            var address8 = document.getElementById("address8").value;
            var mobile8 = document.getElementById("mobile8").value;
            var dob8 = document.getElementById("dob8").value;
            var email8 = document.getElementById("email8").value;
            var city8 = document.getElementById("city8").value;
            var state8 = document.getElementById("state8").value;

            var emailRegex = /^[^\s@]+@[^\s@]+\.[^\s@]+$/;
            var phoneRegex = /^\d{10}$/;
            
            if (name8.trim() === '' || address8.trim() === '' || mobile8.trim() === '' 
            	|| dob8.trim() === '' || email8.trim() === '' || city8.trim() === '' || state8.trim() === '') {
                alert("All fields must be filled out");
                return false;
            }
            
            if (!phoneRegex.test(mobile8)) {
                alert("Invalid phone number");
                return false;
            }

            if (!emailRegex.test(email8)) {
        ...
        <div class="bg-success p-2 text-dark bg-opacity-25">
           ...
           <nav class="navbar navbar-expand-lg bg-body-primary ">
            ...
            <div class="container-fluid  p-3" >
                ...
                <div class="  fs-2 fw-bold text-center text-success" >
                    Admission Form
                </div>
                <hr class=" border border-dark border-2 ">
                <div class=" text-dark  fs-4 fw-bold text-center" >
                    Personal Details
                </div>


                <form id="myForm8" action="SaveAddServlet" method="post" onsubmit="return validateForm8()" >
                
                    <div class="mb-3 row mt-2 d-flex justify-content-center ">

                        <label for="Name" class="col-sm-1 col-form-label text-dark fw-bold ">Name:</label>
                        <div class="col-sm-5">
                            <input type="text"  name="name" class="form-control" id="name8" placeholder="Enter your name" >
                        </div>

                    </div>
                    <div class="mb-3 row d-flex justify-content-center">
                        <label for="Address" class="col-sm-1 col-form-label text-dark fw-bold">Address:</label>
                        <div class="col-sm-5">
                            <input type="text" name="address" class="form-control" id="address8" placeholder="Enter your address">
                        </div>
                    </div>
                    <div class="mb-3 row d-flex justify-content-center">
                        <label for="Mobile" class="col-sm-1 col-form-label text-dark fw-bold">Mobile:</label>
                        <div class="col-sm-5">
                            <input type="text" name="mobile"  class="form-control" id="mobile8"  placeholder="Enter your mobile no">
                        </div>
                    </div>
                    <div class="mb-3 row d-flex justify-content-center">
                        <label for="Date of Birth" class="col-sm-1 col-form-label text-dark fw-bold">DOB:</label>
                        <div class="col-sm-5">
                            <input type="text" name="dob" class="form-control" id="dob8" placeholder="Choose DOB" readonly>
                        </div>
                    </div>
        	...
        	dateFormat:"d-m-Y ",
                    ...
                    <div class="mb-3 row d-flex justify-content-center">
                        <label for="Qualification" class="col-sm-1 col-form-label text-dark fw-bold">Education:</label>
                        <div class="col-sm-5">
                    ...
                    <div class="mb-3 row d-flex justify-content-center">
                        <label for="staticEmail" class="col-sm-1 col-form-label text-dark fw-bold">Email:</label>
                        <div class="col-sm-5">
                            <input type="text" name="email" class="form-control" id="email8" placeholder="Enter your email" >
                        </div>
                    </div>
                    <div class="mb-3 row d-flex justify-content-center">
                        <label for="City" class="col-sm-1 col-form-label text-dark fw-bold">City:</label>
                        <div class="col-sm-5">
                            <input type="text" name="city" class="form-control" id="city8" placeholder="Enter your city">
                        </div>
                    </div>
                    <div class="mb-3 row d-flex justify-content-center">
                        <label for="State" class="col-sm-1 col-form-label text-dark fw-bold">State:</label>
                        <div class="col-sm-5">
                            <input type="text" name="state" class="form-control" id="state8" placeholder="Enter your state">
                        </div>
                    </div>

                    <div class="mb-3 row d-flex justify-content-center">
                        <label for="Course" class="col-sm-1 col-form-label text-dark fw-bold">Course:</label>
                        <div class="col-sm-5">
